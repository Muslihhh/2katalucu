...
<section class="bg-gray-50 dark:bg-gray-900 h-full p-3 sm:p-5 antialiased">
        ...
        <div class="bg-white h-full dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div
                ...
                <div
                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="createProductModal"
    ...
    <h5 id="drawer-label"
        ...
        Product</h5>
    <button type="button" data-drawer-dismiss="createProductModal" aria-controls="createProductModal"
...
=======
                                    ...
                                    <td
                                        ...
                                        <div class="flex items-center justify-center space-x-4">
                                            <button type="button"
                                                onclick="openDrawer('{{ route('products.apdet', $product->id) }}')"
