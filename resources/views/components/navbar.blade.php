<nav x-data="{ isOpen: false }" class="bg-purple-800 sticky top-0 z-50 py-4">
    <div class="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class=" flex lg:w-1/2 sm:w-2/3">
                <div class=" w-full">
                    <form class="w-auto" action="{{ route('home') }}" method="GET">
                        <label class="relative block w-auto">
                            ...
                            <input value="{{ request('search') }}" type="search" id="search" name="search"
                                class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-2 pr-3 shadow-sm focus:outline-none sm:text-sm"
                                placeholder="Search for product..." />
                            <button type="submit"
                                class="fa fa-search absolute inset-y-0 right-0 flex items-center px-4 bg-gradient-to-r bg-purple-800 text-white rounded-r-md hover:bg-purple-500 focus:outline-none focus:ring-2"></button>
                        </label>
                    </form>
                </div>
                ...
                <div>
                    <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown"
                        class=" w-full md:w-auto flex items-center justify-center py-2 px-2 text-sm font-medium text-gray-200 focus:outline-none bg-transparant rounded-lg hover:bg-purple-800 hover:text-gray-100 focus:z-10  "
                        type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="h-4 w-4  text-gray-100"
                            ...
                            <div id="accordion-flush-price" data-accordion="collapse"
                                ...
                                <div id="price-body" class="hidden" aria-labelledby="price-heading">
                                    <div
                                        ...
                                        <form action="{{ route('home.price-filter') }}" method="GET"
            ...
            <div class=" text-gray-200 font-semibold flex">
                @if (Auth::check())
                    <!-- Jika user sudah login -->
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="btn btn-danger px-3 py-2 bg-white border-2 text-purple-700 border-white rounded-lg">Keluar</button>
                    </form>
                @else
                    ...
                    <a href="{{ route('registrasi') }}" class="btn btn-primary">
                        <button
                            class=" px-3 py-2 bg-white border-2 text-purple-700 border-white rounded-lg">Daftar</button>
                    </a>
                @endif
