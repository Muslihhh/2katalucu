      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div id="filterDropdown" class="z-10 hidden px-3 pt-1 bg-white rounded-lg shadow w-80 dark:bg-gray-700 right-0">
            <div class="flex items-center justify-between pt-2">
             ...
             <!-- Category -->
            @props(['categories' => []]) <!-- Mendeklarasikan $categories dengan default sebagai array kosong -->
                                ...
                                @foreach($categories as $category)
                                    <li class="flex items-center">
                                        ...
                                        <label for="category_{{ $category->id }}" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                            <a href="{{ route('home.filter', $category->id) }}" class="hover:underline">{{ $category->name }}</a> ({{ $category->products->count() }}) <!-- Menampilkan jumlah produk dalam kategori -->
                                        </label>
                                    </li>
                                @endforeach
                                <li>
                                  ...
                                  @foreach($categories as $category)
                                      <li class="flex items-center">
                                          ...
                                          <label for="daerah_{{ $category->id }}" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                                              <a href="{{ route('home.filter', $category->id) }}" class="hover:underline">{{ $category->daerah }}</a> ({{ $category->products->count() }}) <!-- Menampilkan jumlah produk di daerah -->
                                          </label>
                                      </li>
                                  @endforeach
                                  <li>
